...
\begin{figure}
\includegraphics{faultlines.png}
\end{figure}
}

\frame{\frametitle{Beispiel (Straßennetz)}
\begin{figure}
\includegraphics{roadnetwork.png}
\end{figure}
}
...
\begin{figure}
\includegraphics[height=2cm,width=2cm,keepaspectratio]{rips1.png}
\end{figure}\pause
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\end{itemize}
			\begin{figure}
			\includegraphics[height=4cm,width=6cm,keepaspectratio]{VR_complex.png}
			\end{figure}
		\end{itemize}
\end{enumerate}
}
...
\frame{\frametitle{Klassendiagramm}
\begin{figure}
\includegraphics[height=10cm,width=11cm,keepaspectratio]{reconstruction_classes.jpeg}
\end{figure}
}
...
\begin{figure}
\includegraphics[height=7cm,keepaspectratio]{trello.png}
\end{figure}
}
